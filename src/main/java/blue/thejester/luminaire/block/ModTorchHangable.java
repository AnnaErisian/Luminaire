...
public class ModTorchHangable extends Block implements IHasOreDict {
    ...
    public ModTorchHangable(String name) {
    ...
    public ModTorchHangable(String name, EnumDyeColor color) {
        this(name);
    ...
    public static Block[] makeTorches(String name, boolean doParticles) {
        ...
        for(EnumDyeColor color : EnumDyeColor.values()) {
            ModTorchHangable torch = new ModTorchHangable(name + "_" + color.getName(), color);
    ...
    protected static final AxisAlignedBB HANGING_AABB = new AxisAlignedBB(0.4000000059604645D, 0.4D, 0.4000000059604645D, 0.6000000238418579D, 1D, 0.6000000238418579D);
    ...
    private boolean canPlaceUnder(World worldIn, BlockPos pos)
    {
        IBlockState state = worldIn.getBlockState(pos);
        if (this == net.minecraft.init.Blocks.END_GATEWAY || this == net.minecraft.init.Blocks.LIT_PUMPKIN)
        {
            return false;
        }
        else if (state.isSideSolid(worldIn, pos, EnumFacing.DOWN) || state.getBlock() instanceof BlockFence || this == net.minecraft.init.Blocks.GLASS || this == net.minecraft.init.Blocks.COBBLESTONE_WALL || state.getBlock() == Blocks.STAINED_GLASS)
        {
            return true;
        }
        else
        {
            BlockFaceShape shape = state.getBlockFaceShape(worldIn, pos, EnumFacing.DOWN);
    ...
    private boolean canPlaceAt(World worldIn, BlockPos pos, EnumFacing facing)
    {
        ...
        else if (facing.equals(EnumFacing.DOWN) && this.canPlaceUnder(worldIn, blockpos))
        {
            return true;
        }
    ...
    protected boolean onNeighborChangeInternal(World worldIn, BlockPos pos, IBlockState state)
    {
        ...
        else
        {
            ...
            else if (enumfacing.equals(EnumFacing.UP) && !this.canPlaceOn(worldIn, blockpos))
            {
                flag = true;
            }
            else if (enumfacing.equals(EnumFacing.DOWN) && !this.canPlaceUnder(worldIn, blockpos))
            {
                flag = true;
            }
